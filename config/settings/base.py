"""
===========================================
 CONFIGURACIÓN BASE DEL BACKEND DJANGO
...
INSTALLED_APPS = [
    ...
    'apps.support.security',
    'apps.business.infrastructure',
    'apps.business.exhibitions',
    'apps.business.wildlife',
    'apps.business.education',
...
MIDDLEWARE = [
    ...
    'apps.support.audit.middleware.AuditLogMiddleware',
